...
public partial class AddMovie : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            // Check if user is admin (status "2" = admin)
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                // Initialize MovieId (will be auto-generated by database)
                newMovie.MovieId = 0;
                ...
                newMovie.Genre = ddlGenre.SelectedValue;
                ...
                if (filePoster.HasFile)
                {
                    try
                    {
                        ...
                        string uploadDir = Server.MapPath("~/images/uploads/");
                        ...
                        // Set poster path (relative to site root)
                        posterPath = "images/uploads/" + uniqueFileName;
                ...
                {
                    // Use default poster if no file uploaded
                    newMovie.Poster = "images/uploads/slider1.jpg";
                }

                // Call web service to add movie (admin check already done in Page_Load)
