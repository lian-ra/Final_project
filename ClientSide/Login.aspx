<%@ Page Title="Login" Language="C#" MasterPageFile="~/Design.master" AutoEventWireup="true" CodeFile="Login.aspx.cs"
    Inherits="Login" %>
        ...
        <div class="custom-login-wrapper">
            <div class="login-card">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtUsername" runat="server" CssClass="form-control-custom"
                ...
                <div class="button-group">
                    <asp:Button ID="btnLogin" runat="server" Text="Sign In" OnClick="AttemptLogin"
                        CssClass="btn-custom btn-signin" />
                    <asp:Button ID="btnMoveToRegister" runat="server" Text="Sign Up" OnClick="MoveToRegister_Click"
